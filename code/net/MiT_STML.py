...
class MiT_gcl(nn.Module):
    def __init__(self, embedding_size, bg_embedding_size=1024, pretrained=True, is_norm=True, is_student=True,
    ...
    def forward(self, x, save_feat=False):
        ...
        if self.is_student:
            x_f1 = self.model.embedding_f(feat)

            x_f1 = l2_norm(x_f1)

        x_g1 = self.model.embedding_g(feat)
